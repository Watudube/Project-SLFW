...
from app.schemas.humans.user_schema import AuthResponse, UserIn
...
def create_account(user_in: UserIn, db: Session = Depends(get_session)):
    ...
    user_in = user_in.model_dump()  # Converts Pydantic model to dict.
    user_in["type"] = "user"

    # Kevin Changed this: Access username as a key as it is now a dict.
